...
\begin{figure}[h]
  ...
  Capture d'écran — Interface de connexion en 2 étapes\\[4pt]
  (Placer l'image dans \texttt{figures/poc-login-steps.png})\vspace{1.2cm}}}
  \caption{Écran d'identification et de saisie du mot de passe.}
...
\begin{figure}[h]
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.2cm}\itshape\color{rtgray}
  Capture d'écran — Défi de double authentification (MFA OTP)\\[4pt]
  (Placer l'image dans \texttt{figures/poc-login-mfa.png})\vspace{1.2cm}}}
  \caption{Écran de confirmation MFA avec code reçu par e-mail.}
...
\begin{figure}[h]
  ...
  Capture d'écran — Tableau de bord d'applications et centre de profil\\[4pt]
  (Placer l'image dans \texttt{figures/poc-dashboard.png})\vspace{1.5cm}}}
  \caption{Vue globale du tableau de bord (applications actives et panneau de profil/sécurité).}
...
\begin{figure}[h]
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.2cm}\itshape\color{rtgray}
  Capture d'écran — Modale interactive de simulation SSO\\[4pt]
  (Placer l'image dans \texttt{figures/poc-sso-modal.png})\vspace{1.2cm}}}
  \caption{Console de logs détaillant le flux Token-Exchange et UserInfo.}
