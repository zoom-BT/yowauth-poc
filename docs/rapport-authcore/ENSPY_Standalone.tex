%%=====================================================================
%%  Rapport d'Analyse & Conception (YowAuth) — Standalone ENSPY
%%  Ne nécessite aucun fichier .cls externe (utilise 'report')
%%  Compilable immédiatement sur un projet vierge Overleaf (pdfLaTeX)
%%=====================================================================
...
% Charte graphique Navy (Bleu ENSPY)
...
\hypersetup{
  ...
  urlcolor=rtaccent,
  citecolor=enspynavy,
  pdftitle={Rapport d'Analyse et Conception YowAuth - ENSPY},
  pdfauthor={Tchoutzine Tchetnkou albino .C}
}
...
\fancyfoot[C]{\small\color{rtgray}ENSPY -- Rapport d'Analyse \& Conception -- YowAuth}
\renewcommand{\headrulewidth}{0.4pt}
\renewcommand{\footrulewidth}{0.4pt}

\titleformat{\chapter}[display]
  {\normalfont\huge\bfseries\color{enspynavy}}
  {\filright\Large Chapitre~\thechapter}{0.6ex}{\Huge}
\titleformat{\section}
  {\normalfont\Large\bfseries\color{enspynavy}}{\thesection}{1em}{}
\titleformat{\subsection}
  {\normalfont\large\bfseries\color{enspynavy!85}}{\thesubsection}{1em}{}

% Boîtes d'invariants et de rôles
...
%---------------------------------------------------------------------
% Page de Garde Personnalisée ENSPY
%---------------------------------------------------------------------
\begin{titlepage}
\centering
\vspace*{0.8cm}
{\large\bfseries ECOLE NATIONALE SUPERIEURE POLYTECHNIQUE DE YAOUNDE (ENSPY)\par}
{\small Université de Yaoundé I\par}
\vspace{0.4cm}
\scalebox{0.7}{\includegraphics{logo_enspy.png}} % Si l'image existe
\vspace{0.4cm}
{\large\bfseries DEPARTEMENT DE GENIE INFORMATIQUE\par}
{\small Spécialité Réseaux Mobiles et Intelligents\par}
\vspace{1cm}

{\color{enspynavy}\rule{\linewidth}{2pt}}\\[0.5cm]
{\Huge\bfseries\color{enspynavy} RT-Comops Backend\par}
\vspace{0.3cm}
{\LARGE Rapport d'Analyse et Conception Technique\par}
\vspace{0.2cm}
{\Large Module \code{auth-core} -- YowAuth\par}
{\color{enspynavy}\rule{\linewidth}{0.8pt}}\\[1.2cm]

\begin{tabular}{rl}
\textbf{Rédigé par :} & Tchoutzine Tchetnkou albino .C (Matricule : 22P387)\\[4pt]
\textbf{Sous la supervision de :} & Pr. Eng Thomas Djotio\\[4pt]
\textbf{Manager / Chef de projet :} & M. Tsafack Fotso Savio\\[4pt]
\textbf{Unité d'Enseignement (UE) :} & Réseaux Mobiles et Intelligents\\[4pt]
\end{tabular}
