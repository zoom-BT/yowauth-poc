...
export const PLATFORMS: Platform[] = [
  ...
  { code: "TREASURY", name: "Trésorerie", tagline: "Encaissements & règlements", icon: "https://images.unsplash.com/photo-1563013544-824ae1d704d3?w=200&auto=format&fit=crop&q=80", url: "https://treasury.yowyob.com", hue: "#0891b2" },
  { code: "BILLING", name: "Facturation", tagline: "Factures & abonnements", icon: "https://images.unsplash.com/photo-1450133064473-71024230f91b?w=200&auto=format&fit=crop&q=80", url: "https://billing.yowyob.com", hue: "#e11d48" },
  ...
  { code: "SETTINGS", name: "Paramètres", tagline: "Configuration plateforme", icon: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=200&auto=format&fit=crop&q=80", url: "https://settings.yowyob.com", hue: "#64748b" },
