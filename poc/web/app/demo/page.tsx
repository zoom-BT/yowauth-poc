  ...
  return (
    <main style={{ fontFamily: "system-ui, sans-serif", maxWidth: 920, margin: "0 auto", padding: "2rem 1rem" }}>
      <p style={{ marginBottom: 8 }}>
        <Link href="/" style={{ color: "#2563eb" }}>← Retour à la connexion</Link>
      </p>
      <h1 style={{ marginBottom: 4 }}>YowAuth — Démo automatique</h1>
      <p style={{ color: "#666", marginTop: 0 }}>
        Déroule tout le flux d&apos;un coup contre <code>{API}</code>
      </p>
